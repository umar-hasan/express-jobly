...
describe("GET /companies", function () {
  ...
  test('tests specific query parameters', async () => {
    let res = await request(app).get("/companies?name=c&minEmployees=1&maxEmployees=2")
    ...
    res = await request(app).get("/companies?name=c&minEmployees=1&maxEmployees=2&asdf=test")
